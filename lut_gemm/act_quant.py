...
def make_actQuant(module, names, name='', 
    ...
    for attr in dir(module):
        ...
        if name1 in names:
            new_module = LinearWithActQuant(tmp.in_features, tmp.out_features, tmp.bias is not None, act_quant_int, act_quant_fp, act_quant_fp_exponent, act_quant_per_block)
